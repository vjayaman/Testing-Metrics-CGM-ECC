...
checkColumns <- function(x, y, tol, it) {
  ...
  # saveRDS(x, paste0("test_results/it", it, "-actual.Rds"))
  # saveRDS(y, paste0("test_results/it", it, "-test.Rds"))
    
  if (all(first_col, second_col, third_col)) {
    print(paste0("Test results and original results are the same, within a tolerance of ", tol))
  }else {
...
for (it in 1:50) {
  ...
  incl_clusters <- datasetSizeBelow(td, 5000)
  ...
  checkColumns(case1a, case1b, 1e-14, it)
}
